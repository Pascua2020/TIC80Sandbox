...
todoJuego = {
    ...
    menuPrincipal = {
        estados = { juegoPrincipal = false,pinball = false,misionStuntman = false,juegoBaile = false,telescopio = false,diarios = false,
            creditos = false,intro = false,demo = false,radios = false,tecladoNum = false,tecladoPC = false,diosGPT=false},
        opciones = { "Juego Principal","Pinball","Mision Stuntman","Juego de Baile","Telescopio","Diarios","DiosGPT","Teclado PC","Teclado Num"},
    ...
    ciudadJuego = (function()
      ...
      local transformadores = { -- Funciones transformadoras específicas
        zonas = function(z)
            ...
            return { nombre = nombre,xInicio = col * 30,yInicio = fila * 17,xFin = col * 30 + ancho * 30,yFin = fila * 17 + alto * 17 }
        end,
      ...
      local datos_raw = { zonas = { {"Nueva Pyongyang", 7, 0}, {"Obelisco", 0, 0}, {"Internets", 1, 0}, {"No no no no", 2, 0}, 
            {"Mar RAM", 2, 0}, {"Mar RAM", 6, 0},{"Mar RAM", 6, 7}, {"Mar RAM", 7, 7}, 
            {"Mar RAM", 0, 7},{"Mar RAM", 1, 7}, {"Mar RAM", 2, 7}, {"Mar RAM", 3, 7},
            {"Mar RAM", 6, 4}, {"Mar RAM", 7, 4}, {"Mar RAM", 0, 4},{"Mar RAM", 1, 4},{"Mar RAM", 3, 0},
            {"Mar RAM", 2, 4}, {"Mar RAM", 3, 3},{"Vivan los Osos", 7, 1}, {"Tigerlandia", 0, 1}, 
        ...
        {"Kamasutra", 233, 233, 55, 58, "vertical"},
        ...
        {"Tuti fruti", 216, 217, 55, 66, "vertical"},{"Viagra", 43, 44, 57, 65, "vertical"},{"Wauf", 63, 86, 63, 65, "horizontal"},
        ...
        npcs = {{258, 59, 72, "Silvestre Stacchotta", 0, 0, 0.3, 0.2},{259, 67, 170, "Suizo Romanche", 0, 0, 0.2, 0.3},
        {260, 1864, 156, "Rapi el Rapero", 0, 0, 0.4, 0.1},{261, 1786, 269, "Timmy Trabalenguas", 0, 0, 0.1, 0.4},
        {262, 1778, 487, "Capitan Inflacion", 0, 0, 0.3, 0.3},{263, 1813, 13, "Obsesivo y Comuplsivo", 0, 0, 0.2, 0.2},
        {265, 465, 470, "Cerebrito y Wachin", 0, 0, 0.1, 0.5},
        {266, 480, 162, "El Payaso Curro Curro", 0, 0, 0.4, 0.2},{273, 272, 156, "Gatito", 0, 0, 0.3, 0.3}},
        coleccionables_monedas = { -- sprite 465 = monedas normales , sprite 468 = monedas especiales
            {1868, 60, 465, false},{1811, 178, 465, false},{108, 279, 465, false},
      ...
      local ciudad = { zonas = procesarDatos(datos_raw.zonas, transformadores.zonas),
        ...
        configuracion = { mostrarSiCalle = false,radioDeteccionNombreNPC = 25 },
    ...
    return {
        misionStuntman = { partes = { [1] = { normal = { SS.."Good day wacho, altas llantas.",
            ...
            ocultos = { fase4 = "Me estoy comiendo un \nChori de chocolate.",
                fase5 = "En Madrid hice un doctorado en \nquitar sostenes.Me saque un 69."}},
    ...
    return {
        ...
        frases = { aCompletar = { lista = { "Tecnofeudalismo", "Cuchi Cuchi Cuchi", "No seas gilipollas", "Viva el britpop", "Party Hard", 
                "Usa condon,no seas pelotudo","Soy la hostia tio"},indice=2 },  
    ...
    local entidades = { -- === ENTIDADES DINÁMICAS ===
        ...
        peces = { necesitaInicializacion = not fishes,
            datos = fishes or { {x=20, y=-20, speed_x=0.6, flip=false, vertical=false, min_x=20, max_x=643},
                ...
                {x=-350, y=18, speed_y=0.4, flip=false, vertical=true, min_y=18, max_y=240}},
            actualizar = function(self)
            ...
            dibujar = function(self)
                for _, avion in pairs(self.datos) do
                    ...
                    if avion.flip then
                        ...
                        r(x - 89, y + 5, 92, 6, 0) p(avion.message, x - 90, y + 5, 4)
                    end
                end
            end
        },
    ...
    local function dibujarTrafico()
        for i, coche in ipairs(todoJuego.ciudadJuego.trafico) do
            ...
            if distancia < 12 * 12 then
                ...
                p(coche.nombre or "Vehículo", (coche.x - todoJuego.estadoJugador.camara.offset.x + 100)%1920+6, 
                      (coche.y - todoJuego.estadoJugador.camara.offset.y + 38)%1080+2, 4)
                if btnp(5) then
...
pelotaDeFutbolX=1868
pelotaDeFutbolY=380
palomaMensajeraX=620
palomaMensajeraY=36
palomaMoviendose=false
palomaCorea=false
avionDePapelMoviendose=false 
avionDestino=false
avionDePapelX=676
avionDePapelY=236
mariposaX=420
mariposaY=500
mariposaMoviendose=false 
mariposaDestino=false
millonesimoDolar=false 
millonesimoMensaje=0
britpopMar=false 
britpopMensaje=0
todoVardo=false
todoVardo2=false
...
todoVardo6=false
todoVardo7=false
temporizadorTodoVardo=0
temporizadorNoticiasDelMundo=0
textoTodoVardoX=0
textoNoticiasDelMundoX=60
indiceTextoTodoVardo=1
indiceTextoNoticiasDelMundo=1

finNoticiaTodoVardo=false
finNoticiaTodoVardo2=false
finNoticiaTodoVardo3=false
finNoticiaTodoVardo4=false
finNoticiaTodoVardo5=false
finNoticiaTodoVardo6=false
finNoticiaTodoVardo7=false
finNoticiaMundo=false
finNoticiaMundo2=false
noticiaTodoVardo = { 
"Estamos en Vivo en Todo Vardo con \nBarcelo Monelli",
"En la Ciudad Rapera de Buenos Aires",
"Barcelo,te saluda Celson Nastro \n: Bello Apocalipsis",
"Celson,esto es terrible.Estamos en \nlas inmediaciones del congreso",
"Hay disturbios y acaba de ocurrir \nalgo delirante : ",
"Un hombre acaba de cortarse su \n entrepierna para usarla como bomba \ncontra la policia",
"Me estas jodiendo Barcelo? \nSe inmolo la salchicha?",
"Si Celson,hay mucha furia,\nmucha falopa,arde el pais!",
"Y como esta la policia? el hombre?",
"Afortunadamente no hay heridos,\nsalvo la salchicha de este hombre",
"Pero no te preocupes : ya fue asistido \npor el ",
"Escuadron de Entrepiernas \nLastimadas del Hospital Yo No Fui",
"Pero que cosa eh? Cada vez hay \neventos mas violentos en el pais",
"Y si,uno como periodista \ncree haberlo visto todo.",
"Les informaremos si la salchicha \nde este hombre logra ser salvada.\n#EstenAtentos",
"#MuchaPauta.CalidadTambien. \n#VuelaElChorizo"}

noticiaTodoVardo2 = { 
"Seguimos con las Bizarradas de esta \nCiudad",
"Les habla Celson Nastro,Bella Desgracia \ny Buen Vomito!",
"Estamos ante una situacion \nverdaderamente insolita en \nel barrio de Nueva Pyongyang",
"Hay una historica Lluvia de Penes.\nSi,lo escucharon bien : LLUEVEN PENES!",
"Aca Barcelo de Todo Vardo,\nson de verdad?",
"Hola Barcelo,no se si son de verdad pero\nson de todos los colores del arcoiris!",
"Y como estan reaccionando los vecinos?",
"Estan preocupados porque \nestan creando danios en la ciudad!",
"AH,ME CAYO UN PENE EN EL OJO!",
"Oh Celson,estas bien?",
"Si,pero a la camara de nuestro \ncamarografo le cayo otro pene.\nY es muy duro!",
"Aca habla Juana,de la Panaderia \nA Comerla,dice que le cayo un \npene en el vidrio del local!",
"Celson,que esta haciendo el \nGobierno para impedirlo?",
...
"Shenzhen funda su primer Villa Miseria inspirada en el Modelo Argentino.",
"Se cayo un peluche gigante en Serbia : 100 Risas confirmadas"
}

obraDeRadioteatro = {
"Narrador Gigolo: \nLa Obra de Radioteatro del Dia.\nTitulo : El Porno Marciano.",
...
function gestionarUbicacion(modo, x, y)
    ...
    if(radioTeatro==false) then 
     spr(442,(340-todoJuego.estadoJugador.camara.offset.x+100)%1920,(412-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
      ...
      rectb(39,59,172,22,4)
            rect(40,60,170,20,2)
            print("Boton 4 : Ver Obra de \nRadioteatro",41,61,4) 
            if(btn(4)) then 
            radioTeatro=true
            end
            end end
    ...
    if(radioTeatro) then 
      cls(0)
      spr(425,(340-todoJuego.estadoJugador.camara.offset.x+100)%1920,(422-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
      if(indiceRadioteatro>=11) then 
      spr(426,(370-todoJuego.estadoJugador.camara.offset.x+100)%1920,(422-todoJuego.estadoJugador.camara.offset.y+48)%1080,0) end
      if(indiceRadioteatro>=20) then 
      spr(415,(400-todoJuego.estadoJugador.camara.offset.x+100)%1920,(422-todoJuego.estadoJugador.camara.offset.y+48)%1080,0) end
    ...
    if(radioTeatro2) then 
      cls(0)
      spr(415,(1820-todoJuego.estadoJugador.camara.offset.x+100)%1920,(120-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
     ...
     spr(457,(84-todoJuego.estadoJugador.camara.offset.x+100)%1920,(436-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
      ...
      rectb(39,59,172,22,4)
            rect(40,60,170,20,2)
            print("Boton 4 : Ver Noticia Urgente \ndel Canal -Todo Vardo-",41,61,4) 
            if(btn(4)) then 
            todoVardo=true 
            finNoticiaTodoVardo2=true
            finNoticiaTodoVardo3=true
            end
            end end
    ...
    if todoVardo then 
        ...
        rect(0,66,250,30,2) 
        rect(0,90,250,6,4)
        temporizadorTodoVardo=temporizadorTodoVardo+1 
        temporizadorNoticiasDelMundo=temporizadorNoticiasDelMundo+1
        print("URGENTE EN TODO VARDO",textoTodoVardoX,66,0)
       -- print(indiceTextoTodoVardo,40,60,0)
        ...
        if finNoticiaMundo==false then 
        print(noticiasDelMundo[indiceTextoNoticiasDelMundo],textoNoticiasDelMundoX,91,3) end
        textoTodoVardoX=textoTodoVardoX-1
        textoNoticiasDelMundoX=textoNoticiasDelMundoX-0.75
    ...
    if(finNoticiaTodoVardo2==false) then 
     ...
     if todoVardo2 then 
       ...
       -- print(indiceTextoTodoVardo,40,60,0)
        ...
        print(noticiasDelMundo2[indiceTextoNoticiasDelMundo],textoNoticiasDelMundoX,91,3) end
        textoTodoVardoX=textoTodoVardoX-1
        textoNoticiasDelMundoX=textoNoticiasDelMundoX-0.75
        if (textoTodoVardoX==-70) then textoTodoVardoX = 240 end
        if (textoNoticiasDelMundoX==-340) then textoNoticiasDelMundoX = 60 end
    ...
    if todoVardo7 then 
     ...
     spr(302,(1836-todoJuego.estadoJugador.camara.offset.x+100)%1920,(260-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 1836 and todoJuego.estadoJugador.jugador.y == 260 ) then 
        rectb(39,59,152,12,4)
            rect(40,60,150,10,2)
            print("Aeropuerto -Vola de Aca!- ",41,61,4)
     rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Fundado por simpaticos \nnarcotraficantes  con dinero del\n lavado de narcogalletitas.  ",41,77,4)
    end
    ...
    spr(302,(388-todoJuego.estadoJugador.camara.offset.x+100)%1920,(476-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 388 and todoJuego.estadoJugador.jugador.y == 476 ) then 
        rectb(39,59,152,12,4)
            rect(40,60,150,10,2)
            print("Playa Promiscua ",41,61,4)

             rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("En esta playa esta prohibido no \n tener sexo ,quien sale de aqui se \n aprende todas las posiciones.  ",41,77,4)
    end
    ...
    spr(302,(524-todoJuego.estadoJugador.camara.offset.x+100)%1920,(60-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 524 and todoJuego.estadoJugador.jugador.y == 60 ) then 
        rectb(39,59,152,12,4)
            rect(40,60,150,10,2)
            print("Jugueteria - Boludo Grande - ",41,61,4)

             rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Cosas innecesarias para gente\n innecesaria.",41,77,4)
    end
    ...
    spr(302,(604-todoJuego.estadoJugador.camara.offset.x+100)%1920,(148-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 604 and todoJuego.estadoJugador.jugador.y == 148 ) then 
        rectb(39,59,192,12,4)
            rect(40,60,190,10,2)
            print("Estacion de Tren - La Insegura - ",41,61,4)

             rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Inseguridad Premium para todos \n Le garantizamos no volver vivo.",41,77,4)
    end
    ...
    spr(302,(124-todoJuego.estadoJugador.camara.offset.x+100)%1920,(68-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 124 and todoJuego.estadoJugador.jugador.y == 68 ) then 
        rectb(39,59,192,12,4)
        rect(40,60,190,10,2)
        print("Parque Suede ",41,61,4)

        rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Cibercafes al aire libre,torneos de \n Britpop y sostenes prohibidos. ",41,77,4)
    end
    ...
    spr(302,(292-todoJuego.estadoJugador.camara.offset.x+100)%1920,(332-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 292 and todoJuego.estadoJugador.jugador.y == 332 ) then 
        rectb(39,59,192,12,4)
            rect(40,60,190,10,2)
            print("Lago Mafioso ",41,61,4)

        rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Se dice que ahi quien pregunta \n demasiado termina durmiendo con \n los peces.",41,77,4)
    end
    ...
    spr(302,(548-todoJuego.estadoJugador.camara.offset.x+100)%1920,(332-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 548 and todoJuego.estadoJugador.jugador.y == 332 ) then 
        rectb(39,59,192,12,4)
            rect(40,60,190,10,2)
            print("Parque de Skate La Tanga",41,61,4)

             rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Portese mal.No lo decimos \n nosotros : es el lema no escrito \n de este pais. ",41,77,4)
    end
    ...
    spr(302,(508-todoJuego.estadoJugador.camara.offset.x+100)%1920,(4-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 508 and todoJuego.estadoJugador.jugador.y == 4 ) then 
        rectb(39,59,192,12,4)
            rect(40,60,190,10,2)
            print("Muelle Infinito ",41,61,4)

             rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Hay almenos 2 grandes mentiras en \n ese titulo. ",41,77,4)
    end
    ...
    spr(302,(172-todoJuego.estadoJugador.camara.offset.x+100)%1920,(12-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 172 and todoJuego.estadoJugador.jugador.y == 12 ) then 
        rectb(39,59,192,12,4)
            rect(40,60,190,10,2)
            print("Obelisco Rapero / Legrand ",41,61,4)

            rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Cada 12 horas \n se escucha el Himno en Forma de \n Rap Barroco Funk Punk.",41,77,4)
    end
    ...
    spr(302,(436-todoJuego.estadoJugador.camara.offset.x+100)%1920,(124-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 436 and todoJuego.estadoJugador.jugador.y == 124 ) then 
        rectb(39,59,192,12,4)
            rect(40,60,190,10,2)
            print("Campo de MiniGolf El Bandido ",41,61,4)

              rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Quien se roba las bolas de golf \n tiene puntos extra...y un posible\n  tiro en la cabeza.",41,77,4)
    end
    ...
    spr(302,(1812-todoJuego.estadoJugador.camara.offset.x+100)%1920,(508-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 1812 and todoJuego.estadoJugador.jugador.y == 508 ) then 
        rectb(39,59,192,12,4)
            rect(40,60,190,10,2)
            print(" Cancha El Laberinto Turbina ",41,61,4)

             rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Aqui Mionel Lessi le gano 12 a -3 \n a Corea del Norte en la \n Final Nuclear de Futbol.",41,77,4)
    end
    ...
    spr(302,(572-todoJuego.estadoJugador.camara.offset.x+100)%1920,(484-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 572 and todoJuego.estadoJugador.jugador.y == 484 ) then 
        rectb(39,59,192,12,4)
            rect(40,60,190,10,2)
            print(" Hoteles de Lujo Fiestas Locas",41,61,4)

             rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Lujo,vulgaridad,tetas falsas y \n yacuzzis de champagne.",41,77,4)
    end
    ...
    spr(302,(84-todoJuego.estadoJugador.camara.offset.x+100)%1920,(468-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 84 and todoJuego.estadoJugador.jugador.y == 468 ) then 
        rectb(39,59,192,12,4)
            rect(40,60,190,10,2)
            print("Planetario Marciano ",41,61,4)

             rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Fundado por pelados de piel verde \n con tendencias reptilianas. ",41,77,4)
    end
    ...
    spr(302,(52-todoJuego.estadoJugador.camara.offset.x+100)%1920,(372-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 52 and todoJuego.estadoJugador.jugador.y == 372 ) then 
        rectb(39,59,192,12,4)
            rect(40,60,190,10,2)
            print("Shopping Ping Pong ",41,61,4)

             rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Todo por 9 millones de pesos!\n Lo unico sin valor es su persona!",41,77,4)
    end
    ...
    spr(302,(284-todoJuego.estadoJugador.camara.offset.x+100)%1920,(404-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 284 and todoJuego.estadoJugador.jugador.y == 404 ) then 
        rectb(39,59,192,12,4)
            rect(40,60,190,10,2)
            print("Narcorosedal la Fresita ",41,61,4)

             rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Con mas Cocaina per capita que \nsus suenios mas fumados!",41,77,4)
    end
    ...
    spr(302,(428-todoJuego.estadoJugador.camara.offset.x+100)%1920,(76-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
       if(todoJuego.estadoJugador.jugador.x == 428 and todoJuego.estadoJugador.jugador.y == 76 ) then 
        rectb(39,59,192,12,4)
            rect(40,60,190,10,2)
            print("Plazita La Desgracia",41,61,4)

             rectb(39,75,192,32,4)
        rect(40,76,190,30,2)
        print("Deje de perder el tiempo\nestando en este horrible lugar.",41,77,4)
    end
   ...
   --print(temporizadorMensajeCajasRotas,40,50,3)


   if (cajasRotas[1] or cajasRotas[2] or cajasRotas[3] or cajasRotas[4]) and (temporizadorMensajeCajasRotas<0 or temporizadorMensajeCajasRotas <120) then temporizadorMensajeCajasRotas=temporizadorMensajeCajasRotas+1 
    rectb(39,59,192,12,4)
    rect(40,60,190,10,0)
    print("+ 10 Monedas",41,61,4)  end
    
  --  if temporizadorMensajeCajasRotas==120 then temporizadorMensajeCajasRotas=1 end
    ...
    todoJuego.estadoJugador.jugador.dinero=todoJuego.estadoJugador.jugador.dinero+10
    cajasRotas[1]=true
    temporizadorMensajeCajasRotas=1
    end end
    ...
    if(todoJuego.estadoJugador.jugador.x == pelotaDeFutbolX and todoJuego.estadoJugador.jugador.y == pelotaDeFutbolY ) then
        rectb(39,49,180,10,2) rect(40,50,178,8,0)
        print("Boton 4 : Patear Pelota",42,52,4)
        if( btnp(4) ) then
    pelotaDeFutbolX=pelotaDeFutbolX-24 end end

    if(palomaCorea==false ) then
    spr(449,(palomaMensajeraX-todoJuego.estadoJugador.camara.offset.x+100)%1920,(palomaMensajeraY-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
    end

    if(todoJuego.estadoJugador.jugador.x == palomaMensajeraX and todoJuego.estadoJugador.jugador.y == palomaMensajeraY ) then
        rectb(39,49,190,20,2) rect(40,50,188,18,0)
        print("Boton 4 : Enviar Paloma Mensajera \na Corea del Norte",42,52,4)
        if( btnp(4) ) then
            palomaMoviendose=true
        end end
    ...
    if(avionDestino==false ) then
    spr(453,(avionDePapelX-todoJuego.estadoJugador.camara.offset.x+100)%1920,(avionDePapelY-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
    end

    if(todoJuego.estadoJugador.jugador.x == avionDePapelX and todoJuego.estadoJugador.jugador.y == avionDePapelY ) then
        rectb(39,49,190,30,2) rect(40,50,188,28,0)
        print("Boton 4 : Enviar Avion de Papel a  \nCentro de Enriquecimiento de \nUranio en Fordow,Iran.",42,52,4)
        if( btnp(4) ) then
            avionDePapelMoviendose=true
        end end
    ...
    if(mariposaDestino==false ) then
    spr(451,(mariposaX-todoJuego.estadoJugador.camara.offset.x+100)%1920,(mariposaY-todoJuego.estadoJugador.camara.offset.y+48)%1080,0)
    end

    if(todoJuego.estadoJugador.jugador.x == mariposaX and todoJuego.estadoJugador.jugador.y == mariposaY ) then
        rectb(39,49,190,30,2) rect(40,50,188,28,0)
        print("Boton 4 : Enviar Mariposa Bomba a \nla Guerra Civil en Khartoum \n( Sudan )",42,52,4)
        if( btnp(4) ) then
            mariposaMoviendose=true
        end end
    ...
    if millonesimoMensaje <= 180 and millonesimoDolar then rectb(39,49,190,30,2) rect(40,50,188,28,0) 
    print("Encontraste un Billete Trucho\ndel Millonesimo Dolar!",42,52,4) end
    ...
    if britpopMensaje <= 180 and britpopMar then rectb(39,49,190,30,2) rect(40,50,188,28,0) 
    print("Encontraste un Album de Britpop\n lanzado en la Antartida!",42,52,4) end
  ...
  --     print((116-todoJuego.estadoJugador.camara.offset.x+100)%1920,30,30,4)
   --    print((140-todoJuego.estadoJugador.camara.offset.y+48)%1080,30,40,4)
        ...
        if(todoJuego.estadoJugador.jugador.x == 116 and 
            ...
            rectb(39,59,152,12,4)
            rect(40,60,150,10,2)
            print("Mostrar nombre de calles?",40,60,4)
        if btnp(4) then 
          todoJuego.ciudadJuego.configuracion.mostrarSiCalle=true 
        end 
        ...
        elseif (todoJuego.estadoJugador.jugador.x == 116 and 
            ...
            rectb(39,59,152,12,4)
            rect(40,60,150,10,2)
            print("Esconder nombres de calles?",40,60,4)
            if btnp(4) then 
          todoJuego.ciudadJuego.configuracion.mostrarSiCalle=false
        end 
    end
        for _, calle in ipairs(todoJuego.ciudadJuego.calles) do
                ...
                if tileY >= calle.y1 and tileY <= calle.y2 then
                    if calle.x1 <= calle.x2 then 
                        if tileX >= calle.x1 and tileX <= calle.x2 then 
                            jugadorEnCalle = true end
                    else if tileX >= calle.x1 or tileX <= calle.x2 then 
                        jugadorEnCalle = true end
                    end
                end
           ...
           if jugadorEnCalle then todoJuego.estadoJugador.jugador.calle,color,mostrarNombre = string.format("%s (%d,%d)", calle.nombre, tileX, tileY),9,true end
            ...
            if calle.x1 > calle.x2 then
                ...
                if screenX1 < screenX2 then
                    ...
                    rect(screenX1, screenY1, MAP_WIDTH - screenX1, alto, color)
                    rect(0, screenY1, screenX2, alto, color)
                end
            end
        end
  ...
  --  rect((todoJuego.ciudadJuego.zonas[1].xInicio*8- todoJuego.estadoJugador.camara.offset.x+100)%1920,(todoJuego.ciudadJuego.zonas[1].yInicio*8- todoJuego.estadoJugador.camara.offset.y+48)%1080,(todoJuego.ciudadJuego.zonas[1].xFin*8-todoJuego.ciudadJuego.zonas[1].xInicio*8- todoJuego.estadoJugador.camara.offset.x+100)%1920,(todoJuego.ciudadJuego.zonas[1].yFin*8-todoJuego.ciudadJuego.zonas[1].yInicio*8- todoJuego.estadoJugador.camara.offset.y+48)%1080,4)
  --  rect((todoJuego.ciudadJuego.zonas[2].xInicio*8- todoJuego.estadoJugador.camara.offset.x+100)%1920,(todoJuego.ciudadJuego.zonas[2].yInicio*8- todoJuego.estadoJugador.camara.offset.y+48)%1080,(todoJuego.ciudadJuego.zonas[2].xFin*8-todoJuego.ciudadJuego.zonas[2].xInicio*8- todoJuego.estadoJugador.camara.offset.x+100)%1920,(todoJuego.ciudadJuego.zonas[2].yFin*8-todoJuego.ciudadJuego.zonas[2].yInicio*8- todoJuego.estadoJugador.camara.offset.y+48)%1080,5)
    
    --pix((todoJuego.ciudadJuego.zonas[1].xInicio*8- todoJuego.estadoJugador.camara.offset.x+100)%1920,3) 
      --     print(todoJuego.ciudadJuego.zonas[1].nombre,60,60,12)
...
function dibujarElementosDelMundo(jugadorX, jugadorY)
    ...
    for i, npc in ipairs(ciudadJuego.npcs) do -- === NPCs ===
        ...
        if math.abs(npc.offsetX) > 9 then 
        npc.speedX,npc.offsetX = -npc.speedX,npc.offsetX + npc.speedX * 2 end -- Rebotar en los bordes

        if math.abs(npc.offsetY) > 9 then 
       npc.speedY,npc.offsetY = -npc.speedY,npc.offsetY + npc.speedY * 2 end
        ...
        local npcScreenX,npcScreenY = (npc.x + npc.offsetX - camara.posicion.x)%1920,(npc.y + npc.offsetY - camara.posicion.y)%1080
        ...
        if distancia < ciudadJuego.configuracion.radioDeteccionNombreNPC then
            ...
            r(textX - 1, textY - 1, #npc.name * 6 + 2, 10, 15) rectb(textX - 1, textY - 1, #npc.name * 6 + 2, 10, 4) p(npc.name, textX+1, textY+1, 4)
            rectb(8,73,218,33,4)
            r(9,74,216,31,2)
    ...
    for tipo, datos in pairs(config) do
        ...
        for i = #datos.particulas, 1, -1 do -- Actualizar y dibujar partículas
            ...
            if p.vida % 2 == 0 or p.parpadeo then
                ...
                if(datos.items == ciudadJuego.coleccionables.objetos) then
                rectb(38,38,160,12,2) rect(39,39,158,10,0) print("Encontraste un Condon!",40,40,4) end
                
                if(datos.items == ciudadJuego.coleccionables.monedas) then
                rectb(38,38,160,12,2) rect(39,39,158,10,0) print("Encontraste una Monedita!",40,40,4) end
                end
   ...
   -- print(todoJuego.menuPrincipal.estados.pinball,40,60,4)
    local interruptores = { -- INTERRUPTORES DE LA CIUDAD : sprite, x, y, condicion, accion, mensaje, condExtra
       ...
       {383, 60, 140, not todoJuego.menuPrincipal.estados.telescopio, function() todoJuego.menuPrincipal.estados.telescopio = true 
        end, "Usar telescopio? boton 4", not activarJetpack},
       {318, 212, 148, true, function() todoJuego.menuPrincipal.estados.Diarios = true 
        end, "Leer Diario? boton 4", not todoJuego.menuPrincipal.estados.Diarios},
        {99, 380, 452, not todoJuego.menuPrincipal.estados.radios, function() todoJuego.menuPrincipal.estados.radios = true 
        ...
        {317, 380, 316, not todoJuego.menuPrincipal.estados.juegoBaile, function() todoJuego.menuPrincipal.estados.juegoBaile = true 
        ...
        {308, 116, 220, not todoJuego.menuPrincipal.estados.tecladoNum, function() todoJuego.menuPrincipal.estados.tecladoNum = true
        end, "Iniciar Teclado Numerico? boton 4"},
        {308, 172, 220, not todoJuego.menuPrincipal.estados.tecladoPC, function() todoJuego.menuPrincipal.estados.tecladoPC = true
        end, "Iniciar Teclado PC? boton 4"},
        {307, 1812, 412, not todoJuego.menuPrincipal.estados.diosGPT, function() todoJuego.menuPrincipal.estados.diosGPT = true
        end, "Iniciar DiosGPT? boton 4"}
  }
  --print(todoJuego.ciudadJuego.configuracion.mostrarSiCalle,140,40,6)
    ...
    s(t.current, 404 - todoJuego.estadoJugador.camara.offset.x + 100, 132 - todoJuego.estadoJugador.camara.offset.y + 48, 0, 2)
...
function dibujarJugador(accion, ...)
    ...
    if not accion or accion == "esParaMisionStuntman" then -- Movimiento del jugador (solo si no es una llamada específica)
        local movimientos = { [0] = function() -- Arriba
                ...
                kilometrosRecorridos=kilometrosRecorridos+1
    ...
    if accion == "esParaMisionStuntman" then -- Lógica específica para la misión Stuntman
        ...
        if type(spriteVehiculo) == "number" then
            ...
            local sprite = (jugador.vehiculo == "Policia" or jugador.vehiculo == "Ambulancia") 
                          and (spriteVehiculo + math.random(0,1)) or spriteVehiculo
            if(jugador.vehiculo == "Policia" or jugador.vehiculo == "Ambulancia") then 
            vehiculo.icono = sprite
            end
        ...
        local especiales = { Globo = function() vehiculo.icono = 495 s(495, x-10, y-20, 0, 3) s(511, x-6, y+5, 0, 2) s(257, x-2, y+10) 
            ...
            ["Lancha Kurro"] = function() vehiculo.icono = 441
              ...
              --  if time() % 0.05 < 0.03 then -- Partículas de agua optimizadas
                    table.insert(todoJuego.efectosVisuales.particulasAgua, { x = x,y = y,
                        dx = (math.random() - 0.5) * 0.5,dy = (math.random() - 0.2) * 0.5,vida = 30,color = 12})
               -- end
               -- print(todoJuego.efectosVisuales.particulasAgua[1].x,70,90,13)
                ...
                for i = #particulas, 1, -1 do
                    ...
                    if p.vida > 0 then 
                        ...
                        elseif(rot==3) then pix((p.x+10 )%1920, (p.y+25 )%1080, p.color) 
                        end
                    --else table.remove(particulas, i)
                    end
                end
             ...
             ["Tren"] = function() vehiculo.icono = 390
               if(rot==0) then
                s(390, x, y, 0, 1, 0, rot, 1, 1)
                s(391, x-10, y, 0, 1, 0, rot, 1, 1)
                s(391, x-20, y, 0, 1, 0, rot, 1, 1)
                s(391, x-30, y, 0, 1, 0, rot, 1, 1)
               end
               if(rot==1) then
                s(390, x, y+40, 0, 1, 0, rot, 1, 1)
                s(391, x, y+10, 0, 1, 0, rot, 1, 1)
                s(391, x, y+20, 0, 1, 0, rot, 1, 1)
                s(391, x, y+30, 0, 1, 0, rot, 1, 1)
               end
                if(rot==2) then
                s(390, x, y, 0, 1, 0, rot, 1, 1)
                s(391, x+10, y, 0, 1, 0, rot, 1, 1)
...
function gestionarEnemigos(modo, x, y)
    ...
    if modo == "stuntman" then -- Modo STUNTMAN (para la misión específica)
        ...
        if math.random(1, 100)> 95 then table.insert(todoJuego.cochesEnemigos,{x=math.random(0,400),y=math.random(0,200),width=8,height=8})
        end 
...
function gestionarEstadoJuegoStuntman(modo, ...)
 ...
 --   print(faseNumero,60,60,3)
    ...
    elseif modo == "gameover" then
       ...
       -- print(todoJuego.dialogosStuntman.estadoMision,60,60,4)
...
function gestionarPantallaStuntman(modo, x, y, f, texto)
    ...
    local function drawGO() -- Pantalla: GAME OVER
        ...
        rect(24,65,185,45,0);rect(1,1,170,20,0);rect(22,25,160,10,0);rect(10,120,160,15,0)
        rectb(23,64,186,46,2);rectb(0,0,170,20,2);rectb(23,24,159,11,2);rectb(9,119,161,16,2)
        ...
        spr(457,1,1,0);spr(258,10,90,0)
        --print(g.booleanos.gameOverFases[1],50,50,3)
    ...
    elseif modo == "temporal" then
        if g.numericos.mensajeTemporal.tiempo > 0 then
            ...
            rectb(px-3, py-3, #g.numericos.mensajeTemporal.texto * 6 + 6, 10, 2)
            rect(px - 2, py - 2, #g.numericos.mensajeTemporal.texto * 6 + 4, 8, 0) print(g.numericos.mensajeTemporal.texto, px, py, 2)
    ...
    elseif texto then
        ...
        rect(x - 2, y - 2, ancho-40, 16, color_fondo) 
        rectb(x - 1, y - 1, ancho-41, 16, 2) print(texto, x+1, y+1, 4)
    end
end
...
function gestionarElementosMisionStuntman()
    ...
    if btnp(5) then -- Disparar desde el vehículo (Botón B)
        table.insert(todoJuego.gestionMisionStuntman.balasCoche, { x = todoJuego.estadoJugador.jugador.x + 8,
            y = todoJuego.estadoJugador.jugador.y + 4,
    ...
    if fraseDisparoTexto then -- Dibujar la frase si está activa
        r(todoJuego.estadoJugador.jugador.x - todoJuego.estadoJugador.camara.posicion.x, 
             todoJuego.estadoJugador.jugador.y - todoJuego.estadoJugador.camara.posicion.y - 20,
             #fraseDisparoTexto*5.5, 10, 2)
        rectb(todoJuego.estadoJugador.jugador.x - todoJuego.estadoJugador.camara.posicion.x-1, 
             todoJuego.estadoJugador.jugador.y - todoJuego.estadoJugador.camara.posicion.y - 21,#fraseDisparoTexto*5.5+1, 11,4)
        p(fraseDisparoTexto, 
              todoJuego.estadoJugador.jugador.x - todoJuego.estadoJugador.camara.posicion.x, 
              todoJuego.estadoJugador.jugador.y - todoJuego.estadoJugador.camara.posicion.y - 20, 4)
    end
...
function gestionarQTEyPersecucionStuntman(tipo, accion, ...)
    ...
    elseif tipo == "qte" then -- Lógica para QTE
        ...
        elseif accion == "draw" then -- Dibujar interfaz QTE
            if qteSystem.active then
                rectb(49, 49, 142, 22, 4)
                rect(50, 50, 140, 20, 3) -- Dibujar fondo del indicador
                local barWidth = (qteSystem.timer/qteSystem.duration) * 140 -- Dibujar barra de tiempo
                rect(50, 50, barWidth, 20, 2)  p("PRESIONA RAPIDO EL BOTON 4 (A)!", 30, 50, 4) -- Instrucciones
                p("Pulsaciones: "..qteSystem.pressCount.."/"..qteSystem.requiredPresses, 60, 80, 4)
...
function todoMisionStuntman()
    ...
    --print(todoJuego.dialogosStuntman.estadoMision,30,70,4)
    --print(numeroFaseFinal,30,80,4)
    local m, e, p, t, j, c = 
    ...
    --gestionarPantallaStuntman("logro","exito")
    ...
    local function dibujarEstela()
        local cx, cy = todoJuego.estadoJugador.jugador.x - todoJuego.estadoJugador.camara.posicion.x + 8, 
                      todoJuego.estadoJugador.jugador.y - todoJuego.estadoJugador.camara.posicion.y + 8
    ...
    if accion == "dibujar" then -- Ejecutar acciones según el parámetro
        ...
        if not todoJuego.gestionMisionStuntman.booleanos.cocheEstaSaltando then
            ...
            if distancia < 40 then
                ...
                local ax, ay = rampa.aterrizajeX - todoJuego.estadoJugador.camara.posicion.x, 
                              rampa.aterrizajeY - todoJuego.estadoJugador.camara.posicion.y
                local cx, cy = todoJuego.estadoJugador.jugador.x + 8 - todoJuego.estadoJugador.camara.posicion.x, 
                              todoJuego.estadoJugador.jugador.y + 8 - todoJuego.estadoJugador.camara.posicion.y
                line(cx, cy, ax, ay, 13)
            end
        end
  ...
  for i, linea in ipairs(lineas) do -- Dibujado
    ...
    spr(303,0,5,0);spr(319,180,0,0) rect(145,20,100,6,0);rect(0,0,240,20,0)
     if todoJuego.menuPrincipal.estados.misionStuntman == true then 
    ...
    if m.booleanos.colision then
        spr(137,40,50,0) rectb(49,49,132,12,3);rect(50,50,130,10,4) print("A donde vas, wachin?",51,51,0)
        m.booleanos.colision=true
    end
 ...
 --dibujarTextoArcoirisBordeado(todoJuego.dialogosStuntman.desarrollo[numAleatorio],0,100,200)
    ...
    if type(e.interruptorParteMisionStuntman)=="string" and e.interruptorParteMisionStuntman:find("cuentaatras")then
        ...
        local phaseHandlers={
            [1]=function()
            rectb(0,20,102,8,4) 
                rect(1,21,100,6,2) print("B: Subir a vehiculo",0,21,4)
                s(362, 1150-c.x, 1050-c.y,0)
            ...
            [2]=function()
                rectb(104,29,142,12,4)
                rect(105,30,140,10,2)
                print("Cajas derribadas: "..p.contadorCajasDerribadas.." / 10",105,30,4)
            ...
            [4]=function()
                ...
                rect(1,20,100,7,0)  rectb(0,19,102,9,2)  print("B: Disparar pistola",1,21,4)
                spr(290,220,0)
            ...
            --m.numericos.mensajeTemporal.texto=""
                ...
                rectb(m.mision.cocheAPerseguir.x-c.x-1,m.mision.cocheAPerseguir.y-c.y-31,122,12,2)
       ...
       -- todoJuego.dialogosStuntman.dialogoDesarrolloRandom=math.random(1,#todoJuego.dialogosStuntman.desarrollo)
        if btnp(4)then 
            numAleatorio=math.random(1,15)
             todoJuego.estadoJugador.jugador.x,todoJuego.estadoJugador.jugador.y = 1086,1055
        todoJuego.dialogosStuntman.estadoMision="" 
        todoJuego.gestionMisionStuntman.booleanos.nitroActivado=false
        todoJuego.gestionMisionStuntman.booleanos.jugadorEstaEnVehiculo=false
        todoJuego.gestionMisionStuntman.booleanos.mostrarObjetivoCompletado=false 
        todoJuego.gestionMisionStuntman.numericos.estadoJuego.interruptorParteMisionStuntman=0 
        todoJuego.gestionMisionStuntman.numericos.estadoJuego.indiceDialogoStuntman=1
        todoJuego.gestionMisionStuntman.numericos.temporizadores.cuentaAtrasStuntman=0 
        todoJuego.gestionMisionStuntman.numericos.temporizadores.temporizadorExplosionRapida=120 
        todoJuego.gestionMisionStuntman.numericos.progreso.puntuacionStuntman=0 
        todoJuego.gestionMisionStuntman.numericos.objetivoTexto="" 
        todoJuego.gestionMisionStuntman.numericos.tiempoMostrarObjetivo=0
        todoJuego.gestionMisionStuntman.numericos.estadoJuego.selectorFase=1.5
         end
    --    todoJuego.gestionMisionStuntman.booleanos = {nitroActivado = false,jugadorEstaEnVehiculo = false,mostrarObjetivoCompletado = false}
    --    todoJuego.gestionMisionStuntman.numericos = { estadoJuego = { interruptorParteMisionStuntman = 0, indiceDialogoStuntman = 1 },
    --        temporizadores = { cuentaAtrasStuntman = 0, temporizadorExplosionRapida = 120 },
    --        progreso = { puntuacionStuntman = 0, objetivoTexto = "", tiempoMostrarObjetivo = 0 } }
         ...
         --   dibujarTextoArcoirisBordeado(todoJuego.dialogosStuntman.descripcionMision,0,0,200) end
            --gestionarEstadoJuegoStuntman("reiniciar:mision")end
        --if btnp(5)then gestionarEstadoJuegoStuntman("reiniciar:fase")end
        --if btnp(5)then gestionarEstadoJuegoStuntman("reiniciar:5")end
        return
    end
    if todoJuego.dialogosStuntman.estadoMision=="10completado"then
        gestionarPantallaStuntman("completado")
        if btnp(4)then reiniciar("reiniciar:mision")end
    end
end
--====== MENUS.LUA (simulado) ======--
    ...
    if tipo == nil then -- Si no se especifica tipo o es nil, ejecutar juego principal
        ...
        elseif tipo == "demo" then -- Lógica para demo
            ...
            if d.dialogoActual <= #d.dialogos then
                rectb(0,0,240,22,2)
                rect(1,1,238,20,0)
                print(d.dialogos[d.dialogoActual], 2, 2, 4)
...
function todoMinijuegoPinball()
    ...
    --config.colision=2
    --print(config.colisiones,60,70,6)
    ...
    if anim and anim.tipo then
        ...
        if anim.tipo == "meteorito" then
            -- Animación de meteorito
        ...
        if bola.x + bola.radius > sprite.x and
           ...
           bola.y - bola.radius < sprite.y + sprite.alto then
            ...
            if tipo == "interactivo" then
                ...
                sfx(2, "E-5", 1, 0, 15, 1) -- Sonido de rebote
            end
        end
    end

   for _, bolaAct in ipairs(bolasActivas) do -- Aplicar colisiones con paletas
        manejarColisionSprite(bolaAct, pinball.objetos.spriteInteractivo, "interactivo")
        manejarColisionSprite(bolaAct, pinball.objetos.spriteRebote, "rebote")
    end
...
function todoMinijuegoBaile()
    ...
    if not todoJuego.baile.juegoActivo then -- Verificar estado del juego
        cls(0) 
        printBordeArcoiris("Juego Terminado", 80, 60, 1) printBordeArcoiris("Puntos finales: " .. v.puntuacion, 60, 80, 1) 
        printBordeArcoiris("Presiona A para reiniciar.", 50, 100, 1)
        if btn(4) then -- Reiniciar juego
            v.puntuacion = 0 v.combos = 0 v.fallos = 0 v.temporizadorFlechas = 0 v.tiempoGeneracionFlechas = 60
    ...
    if ( v.cambioFraseIntervalo == 0) then
    v.indiceFrase = v.indiceFrase + 1
    v.cambioFraseIntervalo = 240 end
        -- Si se llega a la Ultima Frase.
    if v.indiceFrase > #todoJuego.baile.frasesCancion then

            -- Vuelve al inicio de la canción.
    v.indiceFrase = 1 
     end
   ...
   if (v.fallos == 5) then todoJuego.baile.juegoActivo = false end
    ...
    if v.tiempoFraseCombo > 0 then
        printBordeArcoiris("NUEVO COMBO!", 145, 65, 1, true) printBordeArcoiris(todoJuego.baile.fraseComboVisible, 145, 75, 1, true) end
    ...
    if frase then 
        print(frase, 10, 117, 9, false) end
        ...
        if v.radioActual >= 1 and v.radioActual <= 12 then  -- Dibujado de la radio actual
            ...
            if dialogo and dialogo[v.indiceFraseRadio] then
                ...
                for i, linea in ipairs(dividirMensaje(dialogo[v.indiceFraseRadio], 36)) do
                    dibujarTextoConBorde(linea, 10, y + (i-1)*10, 12, 4)
                end
            end
        end
...
function TIC()
    cls(0)
    --if(todoJuego.menuPrincipal.estados.juegoBaile==true) then cls(0) todoMinijuegoBaile() end
   -- if(todoJuego.menuPrincipal.estados.pinball==true) then cls(0) todoMinijuegoPinball() end
   -- if (todoJuego.menuPrincipal.estados.diarios==true) then cls(0) manejarModulos("diario","dibujar");manejarModulos("diario","scroll")  end
   -- if(todoJuego.menuPrincipal.estados.telescopio==true ) then cls(0) manejarModulos("telescopio") end
    --todoMisionStuntman()
    ...
    local game = { states = { menuPrincipal = not anyStateActive(), -- Objeto game con todas las funciones y estados originales
            ...
            creditos = estados.Creditos,intro = estados.intro,demo = estados.demo,diosGPT = estados.diosGPT,tecladoNum = estados.tecladoNum,tecladoPC = estados.tecladoPC},
        handleStates = function(self)
            if self.states.menuPrincipal then self:drawMenu();self:handleMenuInput() end
            if self.states.juegoPrincipal then manejarJuegoPrincipalConMenus() end
            ...
            if self.states.telescopio then manejarModulos("telescopio")
                if btnp(5) then estados.telescopio = false jugador.x, jugador.y = 60, 140 end end
            if self.states.creditos then manejarJuegoPrincipalConMenus("creditos") end
            if self.states.intro then manejarJuegoPrincipalConMenus("intro") end
            if self.states.demo then manejarJuegoPrincipalConMenus("demo") end
            if self.states.tecladoNum then cls(0) manejarModulos("teclado","num") end
            if self.states.tecladoPC then cls(0) manejarModulos("teclado","pc") end
            if self.states.diosGPT then cls(0) manejarModulos("app") end
        end,
        drawMenu = function(self) p("> ELIGE UN MODO <", 60, 20, 14)
            for i = 1, #opciones do
                ...
                rectb(35, y-2, 110,20, colores[i])
                p(i.." "..text, selected and 40 or 50, y, colores[i])
            end
        ...
        handleMenuInput = function(self)
            if (estados.juegoPrincipal==false and 
                estados.juegoBaile==false and 
                estados.pinball==false and 
                estados.misionStuntman==false and 
                estados.diarios==false and 
            estados.telescopio==false and 
            estados.creditos==false and 
            estados.intro==false and 
            estados.demo==false and 
            estados.tecladoNum==false and 
            estados.tecladoPC==false and 
            ...
            if btnp(4) then -- Selección de modo
                ...
                local actions = { 
                    [1] = function() estados.juegoPrincipal = true end,
                    [2] = function() estados.pinball = true end,
                    [3] = function() estados.misionStuntman = true end,
                    [4] = function() estados.juegoBaile = true end,
                    [5] = function() estados.telescopio = true end,
                    [6] = function() estados.Diarios = true end,
                    [7] = function() estados.diosGPT = true end,
                    [8] = function() estados.tecladoPC = true end,
                    [9] = function() estados.tecladoNum = true end
                }
        ...
        showDebug = function(self) r(194, 110, 70, 110, 0) rectb(194,110,45,26,2)
            for _,p in ipairs{{jugador.x,124,4,"X: "},{jugador.y,130,4,"Y: "},{jugador.x/8,112,3,"Xc:"},
            {jugador.y/8,118,3,"Yc:"}} do print(p[4]..p[1],195,p[2],p[3]) end
            --print("OffsetX "..todoJuego.estadoJugador.camara.offset.x,110,80,4)
            --print("OffsetY "..todoJuego.estadoJugador.camara.offset.y,110,90,4)
        end
    }
    game:handleStates() 
